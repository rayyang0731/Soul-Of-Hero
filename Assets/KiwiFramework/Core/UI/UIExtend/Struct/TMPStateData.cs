...
namespace KiwiFramework.UI
{
    ...
    public struct TMPStateData
    {
        ...
        /// 默认数据
        /// </summary>
        public static TMPStateData Default
        {
            get
            {
                return new TMPStateData("State Name", false, string.Empty, -1, false, null, false, Color.black);
            }
        }

        public TMPStateData(string _name, bool _use_i18n, string _tableName, int _tableID, bool _overrideFont, TMPro.TMP_FontAsset _font, bool _overrideColor, Color _color)
        {
            name = _name;
            use_i18n = _use_i18n;
        ...
        public static TMPStateData Default
        {
            get
            {
                return new TMPStateData(false, string.Empty, -1, false, null, false, Color.black);
            }
        }

        public TMPStateData(bool _use_i18n, string _tableName, int _tableID, bool _overrideFont, TMPro.TMP_FontAsset _font, bool _overrideColor, Color _color)
        {
            use_i18n = _use_i18n;
            tableName = _tableName;
            tableID = _tableID;
