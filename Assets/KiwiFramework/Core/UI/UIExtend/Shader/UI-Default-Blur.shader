//Base on Unity built-in shader source.

Shader "Kiwi/UI/Default-Blur"
{
    Properties
    {
    ...
    v2f vert_BlurVertical(appdata_base v)
    {
        ...
        o.uv = fixed4(grabPos.xy, 1, 1);
        // 设置偏移
        o.offset = _GrabTexture_TexelSize.xy * fixed2(1.0, 0.0) * _BlurSize ;
        return o;
    }
    ...
    v2f vert_BlurHorizontal(appdata_base v)
    {
        ...
        o.uv = fixed4(grabPos.xy, 1, 1);
        // 设置偏移
        o.offset = _GrabTexture_TexelSize.xy * fixed2(0.0, 1.0) * _BlurSize;
        return o;
    }
