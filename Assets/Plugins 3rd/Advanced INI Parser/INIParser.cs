...
public class INIParser
{
    ...
    public Dictionary<string, Dictionary<string, string>> All =>
        new Dictionary<string, Dictionary<string, string>>(m_Sections);
    ...
    public void Open(TextAsset name, bool autoFlush = false)
    {
        if (name == null)
        {
    ...
    public void OpenFromString(string str, bool autoFlush = false)
    {
        m_FileName = null;
        Initialize(str, autoFlush);
    }
